...
export const metadata: Metadata = {
  title: "Pizzeria - Authentic Pizza Experience",
  description: "Discover our handcrafted pizzas made with the finest ingredients.",
  openGraph: {
    title: "Pizzeria - Authentic Pizza Experience",
    description: "Discover our handcrafted pizzas made with the finest ingredients.",
    ...
    siteName: "Pizzeria",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_346q1PwyWBLFgxn5R5gWYFVRO0Y/tmp/pizzeria-interior-1760908602319-d65010dc.jpg",
  ...
  twitter: {
    ...
    title: "Pizzeria - Authentic Pizza Experience",
    description: "Discover our handcrafted pizzas made with the finest ingredients.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_346q1PwyWBLFgxn5R5gWYFVRO0Y/tmp/pizzeria-interior-1760908602319-d65010dc.jpg"]
  },
  robots: {
    index: true,
    follow: true
...
(function() {
  ...
  const getElementType = (element) => {
    ...
    // Image elements - including those with background images
    ...
    // Button elements - including those with role="button"
    if (tagName === 'button' || element.getAttribute('role') === 'button') return 'Button';
    
    // Check for clickable elements that might be buttons
    if ((tagName === 'a' || tagName === 'div' || tagName === 'span') && 
        (element.getAttribute('onclick') || 
         element.style.cursor === 'pointer' ||
         computedStyle.cursor === 'pointer')) {
      // If it has href, treat as link/text, otherwise treat as button
